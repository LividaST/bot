      ...
      try {
        ...
        if (command) {
          ...
          if (msg.channel.type !== "dm") {
            ...
            if (command.permissions && !msg.guild.me.hasPermission("EMBED_LINKS") && !client.creators.ids.includes(msg.author.id)) return msg.reply(`I am missing the \`EMBED_LINKS\` permission!`);
          }
