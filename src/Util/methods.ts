...
export const regenCanvas = async (client) => {
	const startTime = Date.now(), 
		data = await client.fetch('https://livida.net/api/radio/').then(res => res.data).catch(null),
	...
	client.canvasTime = Date.now() - startTime;
}