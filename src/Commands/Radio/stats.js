    ...
    run: async (client, msg, args) => {
        ...
        .then(json => {
            let embed = new client.Embed()
                .setDescription(
`
${json.live.is_live ? `${json.live.streamer_name} is current broadcasting on RiseFM` : "We are broadcasting an automated session on RiseFM"} to ${json.listeners.unique} listener${json.listeners.unique > 1 || json.listeners.unique < 1 ? `s!` : `!`}
