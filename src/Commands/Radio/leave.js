module.exports = {
  ...
  run: async (client, msg, args) => {
    ...
    if (msg.member.roles.cache.some(role => role.name === 'DJ') === false && !client.creators.ids.includes(msg.author.id)) return msg.channel.send(new client.Embed().error('You need to have the role called `DJ` to use this command.'))
