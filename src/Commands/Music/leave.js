module.exports = {
    ...
    run: async (client, msg, args) => {
        ...
        if(!voiceChannel || voiceChannel.id !== player.voiceChannel.id) return msg.channel.send(new client.Embed().error(`You need to be in the same voice channel as me to use the leave command!`));
